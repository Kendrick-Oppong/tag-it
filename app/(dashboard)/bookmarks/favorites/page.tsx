...
import { fetchFavoriteBookmarks, fetchUserData } from "@/lib/api";
import { BookOpen } from "lucide-react";

export default async function AllBookmarks() {
  const { bookmarks } = await fetchFavoriteBookmarks();
      ...
      {hasBookmarks ? (
        ...
        <div className="flex flex-col gap-5 items-center justify-center text-center mt-32 px-4 ">
          ...
          <p className="max-w-md text-muted-foreground">
            You haven’t added any favorites. Start exploring and save your
