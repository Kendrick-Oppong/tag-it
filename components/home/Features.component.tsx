  ...
  return (
    <section id="features" className="py-20 px-4 md:px-10 bg-muted/5">
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="mb-6">Built for Velocity</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature) => (
            <div
              key={feature.title}
              className="p-6 outline outline-border  bg-card hover:bg-card/80 hover:shadow-lg transition-all duration-300"
            >
